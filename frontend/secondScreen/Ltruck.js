...
const Ltruck = (props) => {
    ...
    const[truck_size,setTruck_size] = useState('Large Truck');
    const[description,setDescription] = useState('3-4 Bedrooms (1200-2400 sqft)');
    ...
    const sendCred = async (props) => {
        fetch("https://fe0dc0bf.ngrok.io/truck", {
            method: "POST",
            headers: {
    ...
    return(
        <ImageBackground source={require('../assets/grey.jpg')} style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <Text style={{fontSize: 25, fontWeight: 'bold', color: "#D30B0B"}}>Large Truck Details</Text>
